...
int main()
{
    ...
    xil_printf("Variant A - PS latency = %u us\r\n", (unsigned int)us);
    xil_printf("Variant A - PS latency = %u ms\r\n", (unsigned int)(us / 1000));
	...
	xil_printf("Variant-A-SAD MAE = %u.%03u px\r\n", mae_x1000 / 1000, mae_x1000 % 1000);
	xil_printf("Variant-A-SAD Bad >1 px = %u.%02u %%\r\n", bad1_x100 / 100, bad1_x100 % 100);
	xil_printf("Variant-A-SAD Bad >3 px = %u.%02u %%\r\n", bad3_x100 / 100, bad3_x100 % 100);
